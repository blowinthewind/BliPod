...
<template>
  <div class="modal-overlay" v-if="visible" @click.self="close">
    <div class="dialog">
      ...
      <div class="create-modal-overlay" v-if="showCreateModal" @click.self="showCreateModal = false">
        <div class="create-modal">
          ...
          <div class="create-actions">
            ...
            <button class="create-btn confirm" @click="createAndAdd" :disabled="!newPlaylistName.trim()">创建并添加</button>
          </div>
        </div>
      </div>
    </div>
