...
export const builtInThemes: Theme[] = [
  {
    ...
    colors: {
      ...
      textPrimary: '#f2f1ee',
      textSecondary: '#b1aca3',
      textSecondaryStrong: '#cbc5bc',
      textTertiary: '#756f68',
      accent: '#b97757',
      accentHover: '#c58665',
  ...
  },
  {
    ...
    colors: {
      ...
      accentLilac: 'color-mix(in oklch, oklch(60% 0.085 36) 34%, oklch(67% 0.012 8) 66%)',
      accentViolet: 'color-mix(in oklch, oklch(60% 0.085 36) 44%, oklch(59% 0.016 6) 56%)',
      accentSky: 'color-mix(in oklch, oklch(60% 0.085 36) 24%, oklch(72% 0.008 220) 76%)',
      accentAmber: 'color-mix(in oklch, oklch(60% 0.085 36) 58%, oklch(71% 0.045 72) 42%)',
      accentMint: 'color-mix(in oklch, oklch(60% 0.085 36) 20%, oklch(71% 0.014 165) 80%)',
  ...
  },
  {
    ...
    colors: {
      ...
      accentLilac: 'color-mix(in oklch, oklch(59% 0.082 190) 40%, oklch(65% 0.016 250) 60%)',
      accentViolet: 'color-mix(in oklch, oklch(59% 0.082 190) 48%, oklch(58% 0.018 238) 52%)',
      accentSky: 'color-mix(in oklch, oklch(59% 0.082 190) 34%, oklch(72% 0.012 216) 66%)',
      accentAmber: 'color-mix(in oklch, oklch(59% 0.082 190) 46%, oklch(70% 0.045 72) 54%)',
      accentMint: 'color-mix(in oklch, oklch(59% 0.082 190) 44%, oklch(70% 0.018 165) 56%)',
  ...
  },
  {
    ...
    colors: {
      ...
      accentLilac: 'color-mix(in oklch, oklch(58% 0.08 38) 28%, oklch(74% 0.01 6) 72%)',
      accentViolet: 'color-mix(in oklch, oklch(58% 0.08 38) 34%, oklch(63% 0.012 4) 66%)',
      accentSky: 'color-mix(in oklch, oklch(58% 0.08 38) 18%, oklch(72% 0.01 220) 82%)',
      accentAmber: 'color-mix(in oklch, oklch(58% 0.08 38) 48%, oklch(74% 0.04 72) 52%)',
      accentMint: 'color-mix(in oklch, oklch(58% 0.08 38) 16%, oklch(73% 0.012 160) 84%)',
